  ...
  return (
    <div className='footer'>
      ...
      <div>
        ...
        <p><span className='span'><i className="fa-solid fa-phone"></i></span>+254 700112244</p>
        <p><span className='span'><i className="fa-solid fa-phone"></i></span>+254 711334488</p>
        <p><span className='span'><i className="fa-solid fa-envelope-open"></i></span>partynet@gmail.com</p>
        <p><span className='span'><i className="fa-solid fa-location-dot"></i></span>Nairobi, Kenya - 4001004</p>
      </div>
      <div>
